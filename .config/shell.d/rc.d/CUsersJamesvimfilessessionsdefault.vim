...
inoremap  u
inoremap  +
inoremap <silent> <expr> " coc#_insert_key('request', '0a26ea09-693f-11ea-8cdf-c1749f8bd37a')
inoremap <silent> <expr> ' coc#_insert_key('request', '0a26ea08-693f-11ea-8cdf-c1749f8bd37a')
inoremap <silent> <expr> ( coc#_insert_key('request', '0a26ea00-693f-11ea-8cdf-c1749f8bd37a')
inoremap <silent> <expr> ) coc#_insert_key('request', '0a26ea01-693f-11ea-8cdf-c1749f8bd37a')
inoremap <silent> <expr> < coc#_insert_key('request', '0a26ea06-693f-11ea-8cdf-c1749f8bd37a')
inoremap <silent> <expr> > coc#_insert_key('request', '0a26ea07-693f-11ea-8cdf-c1749f8bd37a')
xnoremap <silent> î :call multiple_cursors#select_all("v", 0)
nnoremap <silent> î :call multiple_cursors#select_all("n", 1)
inoremap <silent> <expr> [ coc#_insert_key('request', '0a26ea02-693f-11ea-8cdf-c1749f8bd37a')
inoremap <silent> <expr> ] coc#_insert_key('request', '0a26ea03-693f-11ea-8cdf-c1749f8bd37a')
inoremap <silent> <expr> ` coc#_insert_key('request', '0a26ea0a-693f-11ea-8cdf-c1749f8bd37a')
inoremap jj 
cmap w!! w !sudo tee % >/dev/null
inoremap <silent> <expr> { coc#_insert_key('request', '0a26ea04-693f-11ea-8cdf-c1749f8bd37a')
inoremap <silent> <expr> } coc#_insert_key('request', '0a26ea05-693f-11ea-8cdf-c1749f8bd37a')
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set background=dark
