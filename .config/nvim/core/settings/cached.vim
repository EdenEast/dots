...
" Backups
let g:backup_dir=g:cache_root . '/backup'
call eden#path#create_dir(g:backup_dir)
let &backupdir=g:backup_dir

" Swap
let g:swap_dir=g:cache_root . '/swap'
...
if has('persistent_undo')
  let g:undo_dir=g:cache_root . '/undo'
...
" Viminfo
if has('viminfo')
  let g:viminfo_file=g:cache_root . '/viminfo'
  let &viminfo=g:viminfo_file
endif

" Session views
if has('mksession')
  let g:session_dir=g:cache_root . '/session'
  call eden#path#create_dir(g:session_dir)
  " set viewdir=&g:session_dir
