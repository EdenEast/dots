...
local goodby_widget = wibox.widget.textbox('Goodbye ' .. username.sub(1,1):upper() .. username:sub(2))
goodby_widget.font = "sans 70"
...
local hibernate_icon = wibox.widget.imagebox(beautiful.hibernate_icon)
hibernate_icon.resize = true
hibernate_icon.forced_width = icon_size
hibernate_icon.forced_height = icon_size
local hibernate_text = wibox.widget.textbox('Hibernate')
hibernate_text.font = text_font

local hibernate = wibox.widget{
    {
        nil,
        hibernate_icon,
        nil,
...
exit_screen.bg = beautiful.exit_screen_bg or beautiful.wibar_bg or '#282828'
